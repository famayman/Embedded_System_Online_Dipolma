...
/* ================ Base Addresses ================================ */
/* ================================================================ */
#define GPIOA_Base	0x3B	  //This is address  of PINA so it will be its first reg in struct
#define GPIOB_Base	0x38	  //This is address  of PINB so it will be its first reg in struct			
#define GPIOC_Base	0x35	  //This is address  of PINC so it will be its first reg in struct
#define GPIOD_Base	0x32	  //This is address  of PIND so it will be its first reg in struct		
